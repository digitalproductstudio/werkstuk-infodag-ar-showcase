...
function handleVoiceCommand(transcript) {
    const commands = {
        ...
        // bubble actions
        "imd": () => handleBubbleClick("link"),
        "school": () => handleBubbleClick("link"),
        "join": () => handleBubbleClick("link"),

        // game actions
        "game": () => handleBubbleClick("grow"),
        "play game": () => handleBubbleClick("grow"),

        // next step
        "next": () => driverObj.moveNext(),
        "continue": () => driverObj.moveNext(),
        "skip": () => driverObj.moveNext(),

        // previous step
        "back": () => driverObj.movePrevious(),
        "previous": () => driverObj.movePrevious(),
